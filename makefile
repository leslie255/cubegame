...
bin/game: bin/main.o bin/game.o bin/window.o bin/shader.o bin/camera.o bin/chunk.o bin/block.o bin/string.o bin/text.o bin/atlas.o bin/texture.o bin/mesh.o bin/array.o
	$(CC) $(LDFLAGS) $^ -o $@
